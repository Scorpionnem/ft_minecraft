...
/*   Updated: 2025/09/30 17:13:44 by mbatty           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	TitleScene::onEnter()
{
	...
	_soloButton = new Button(textures.get("button"), textures.get("button_highlighted"), glm::vec2(0, -20), glm::vec2(0.5, 0.5), glm::vec2(1, 1));
	...
	_multiplayerButton = new Button(textures.get("button"), textures.get("button_highlighted"), glm::vec2(0, 0), glm::vec2(0.5, 0.5), glm::vec2(1, 1));
	_icon = new Image(textures.get("ft_minecraft"), glm::vec2(0, -80), glm::vec2(0.5, 0.5), glm::vec2(0.25, 0.25));
	_textTest = new Text("Singleplayer", textures.get("ascii"), glm::vec2(0, -20), glm::vec2(0.5), glm::vec2(1));
	_textTest1 = new Text("Multiplayer", textures.get("ascii"), glm::vec2(0, 0), glm::vec2(0.5), glm::vec2(1));
	_textTest2 = new Text("Options", textures.get("ascii"), glm::vec2(-50, 40), glm::vec2(0.5), glm::vec2(1));
	_textTest3 = new Text("Quit game", textures.get("ascii"), glm::vec2(50, 40), glm::vec2(0.5), glm::vec2(1));
	_textAuthor = new Text("By mbatty & mbirou", textures.get("ascii"), glm::vec2(0, 0), glm::vec2(1), glm::vec2(1));

	_fpsText = new Text("fps", textures.get("ascii"), glm::vec2(0, 0), glm::vec2(0), glm::vec2(1));
}
